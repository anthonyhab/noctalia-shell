...
Item {
  ...
  BarPill {
    ...
    icon: "palette"
    text: (Settings.data.omarchy.active && OmarchyService.themeName) ? OmarchyService.themeName : ""
    autoHide: false
    forceOpen: !isBarVertical && root.displayMode === "alwaysShow"
    forceClose: isBarVertical || root.displayMode === "alwaysHide" || !pill.text || !Settings.data.omarchy.active
    tooltipText: {
      if (!Settings.data.omarchy.active) {
        return I18n.tr("tooltips.omarchy-inactive")
      }
