...
ColumnLayout {
  ...
  NComboBox {
    label: I18n.tr("bar.widget-settings.omarchy-theme-switcher.display-mode.label")
    description: I18n.tr("bar.widget-settings.omarchy-theme-switcher.display-mode.description")
    minimumWidth: 134
    model: [{
        "key": "onhover",
